...
java %RAM% -Djava.library.path=%NATIVES_DIR% -cp 
%MC_DIR%\libraries\com\mojang\netty\1.6\netty-1.6.jar;
...
%MC_DIR%\libraries\com\mojang\authlib\1.5.24\authlib-1.5.24.jar;
%MC_DIR%\libraries\com\mojang\realms\1.10.8\realms-1.10.8.jar;
...
%MC_DIR%\libraries\it\unimi\dsi\fastutil\7.0.12_mojang\fastutil-7.0.12_mojang.jar;
